...
public class XmlUtils {
    ...
    public static Map<String, String> toMap(byte[] xmlBytes,String charset) throws Exception{
        ...
        Map<String, String> params = com.qh.paythird.dianxin.utils.XmlUtils.toMap(doc.getRootElement());
        return params;
    }
    ...
    public static String getMsg(String xml) {
        int s_index = xml.indexOf("<Msg>");
        int e_index = xml.indexOf("</Msg>");
        String rspMsg = null;
        if (s_index > 0) {
            rspMsg = xml.substring(s_index + 5, e_index);
        }
        return rspMsg;
    }
