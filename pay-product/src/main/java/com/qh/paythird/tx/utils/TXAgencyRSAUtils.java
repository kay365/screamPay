...
public class TXAgencyRSAUtils {
	...
	public static String sign(byte[] data, String privateKey) throws Exception {
		...
		return TXAgencyBase64.encode(encryptData);
	}
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		byte[] digest = sha1(data);
		byte[] encryptData = decryptByPublicKey(TXAgencyBase64.decode(sign), publicKey);
	...
	public static String decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
		byte[] keyBytes = TXAgencyBase64.decode(privateKey);
	...
	public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey) throws Exception {
		byte[] keyBytes = TXAgencyBase64.decode(publicKey);
	...
	public static String encryptByPublicKey(byte[] data, String publicKey) throws Exception {
		...
		out.close();
		return TXAgencyBase64.encode(encryptedData);
	}
	...
	public static String loadPublicKey(String fileName) {
		...
		try {
			...
			byte[] buffer = TXAgencyBase64.decode(sb.toString());
			KeyFactory keyFactory = KeyFactory.getInstance("RSA");
			X509EncodedKeySpec keySpec = new X509EncodedKeySpec(buffer);
			RSAPublicKey rsaPublicKey = (RSAPublicKey) keyFactory.generatePublic(keySpec);
			String publickey = TXAgencyBase64.encode(rsaPublicKey.getEncoded());
			return publickey;
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static String loadPrivateKey(String filename) {
		...
		try {
			...
			return TXAgencyBase64.encode(binaryData);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			try {
