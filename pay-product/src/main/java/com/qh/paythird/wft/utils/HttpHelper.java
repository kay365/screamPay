...
public class HttpHelper {
     ...
     * @throws IOException
     */
    public JSONObject getJSONFromHttp(String url, Map<String, Object> param, HttpMethodType method) throws RuntimeException, JSONException {
        String rs;
        switch (method) {
            case GET: {
        ...
        logger.info("return is:" + rs);
        JSONObject jsonRs = new JSONObject(rs);
        return rs == null || "".equals(rs) ? null : jsonRs;
    }
